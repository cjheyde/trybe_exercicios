// 5. Faça um programa que defina três constantes com os valores dos três ângulos internos de um
...
if (angulo1 > 0 && angulo2 > 0 && angulo3 > 0) {
    ...
    console.log("Erro - pelo menos um dos ângulos é inválido, ou seja: tem valor negativo");
}